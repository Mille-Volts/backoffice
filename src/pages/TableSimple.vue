<template>
  <content-layout>
    ...
    <mv-table :data="table">
      <table-column prop="date" date label="Date" width="180" align="left" sortable></table-column>
      ...
      <table-column prop="date" datetime="YYYY-MM-DD / HH:mm:ss" label="Date et heure" width="240"></table-column>
